...
main() {
  ...
  test("exo3", () {
    ...
    expect(countAl(FileReader.fromString("a la pause al bundy a une lampe et il est allité")), 2); expect(countAl(FileReader.fromString("il a la faim")), 0); expect(countAl(FileReader.fromString("")), 0);
  ...
  test("exo4", () {
    ...
    expect(countWords(FileReader.fromString("One")), 1); expect(countWords(FileReader.fromString("One.")), 1); expect(countWords(FileReader.fromString("One. Two")), 2); expect(countWords(FileReader.fromString("a")), 1); expect(countWords(FileReader.fromString("")), 0); expect(countWords(FileReader.fromString(".")), 0); expect(countWords(FileReader.fromString("..")), 0);
  });
  test("exo5", ()
  {
  ...
  expect(countWord(FileReader.fromString("un mot... mais: un autre mot"), "mot"), 2);
